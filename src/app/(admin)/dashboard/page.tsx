...
function StatusBadge({ status }: { status: UserProfile['cardStatus'] }) {
  ...
  // The type of `variant` is inferred from `statusMap` and can be "default", "secondary", "destructive", or "outline".
  // All these values are valid for the `Badge` component's `variant` prop.
  // We need to assert the type to satisfy TypeScript.
